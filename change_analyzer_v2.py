...
def analyse(df_raw):
    ...
    if F["CR_Assignee_Group"]:
        df_cr["CR_Assignee_Group"] = df_cr["CR_Assignee_Group"].fillna("(Unassigned)").astype(str).replace("", "(Unassigned)")
    ...
    if F["Task_Assignee_Group"]:
        df_all["Task_Assignee_Group"] = df_all["Task_Assignee_Group"].fillna("(Unassigned)").astype(str).replace("", "(Unassigned — Cancelled/No Group)")
